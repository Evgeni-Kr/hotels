...
(GET)/property-view/hotels - getting a list with brief information about hotels
(GET)/property-view/hotels/{id} -getting full information about hotel by id
(GET)/property-view/search?parametre= - search hotel by parametre(brand, name, city , country,amenities)
